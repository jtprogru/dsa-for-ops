...
- **Основы программирования** — теоретический курс «Основы алгоритмизации и программирования» (Python 3.14 и Go 1.25): алгоритмизация, Python, ООП, стандартная библиотека, разработка приложений, качество кода.
