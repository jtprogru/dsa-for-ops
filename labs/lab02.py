...
1. Реализовать связанный список
    - Реализовать класс с одни полем - целое число.
    - Добавить поле для организации ссылки.
    - Реализовать список из 6-7 узлов
    - Реализовать функцию - добавление узла в список
    - Реализовать функцию - удаление узла из списка
    - Реализовать функцию - печать списка
2. Реализовать очередь на основе связанного списка.
3. Реализовать методы добавления узла, извлечения узла, получение значения узла
4. Реализовать метод распечатки очереди.
5. Реализовать бинарное дерево на основе связанного списка.
6. Реализовать методы добавления узла
...
def main() -> None:
    # Связанный список
    print("=" * 30)
    print("Связанный список (7 узлов):")
    ll = LinkedList()
    ...
    ll.remove(30)
    ll.print_list()
    print("Удаляем головной узел (10):")
    ll.remove(10)
    ll.print_list()
